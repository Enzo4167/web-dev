      ...
      <div class="row mt-2">
        <div class="col-10">
          <div class="wd-input-group">
            ...
            <input type="text" placeholder="Search Twitter" class="mb-2 wd-input"/>
          </div>
        </div>
